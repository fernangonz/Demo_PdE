...
def build_calado_like(
    ...
    *,
    ...
    b_si = pdf.process_box(
        ...
        [
            "• Percentil",
            "• Seleccion indicador (Por umbral / Predefinido)",
            "• Indicador climatico (si es predefinido)",
        ],
        font_size=11,
        line_h=15,
    )
    ...
    b_por = pdf.process_box(
        ...
        sel_top,
        300,
        "Seleccionar por umbral",
        [
            "Indicador que contenga el umbral",
            "obtenido en el paso 6",
            "(o desde diagrama sin fila en 5b)",
        ],
        font_size=11,
        line_h=13,
        header_h=26,
    ...
    b_cont = pdf.process_box(
        ...
        [
            "• Valor del escenario Historico",
            "• Valores de todos los escenarios futuros",
            "##Criterio espacial:",
            "Si existen varios puntos o indicadores candidatos,",
            "seleccionar el indicador cuya Lon/Lat este mas cerca",
            "del centroide del area donde se localiza el activo.",
        ],
        font_size=11,
        line_h=14,
    )
